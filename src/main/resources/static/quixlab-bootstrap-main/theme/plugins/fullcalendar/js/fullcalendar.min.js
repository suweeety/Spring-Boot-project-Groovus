...
!function (t, e) {
  ...
  return function (t) {
    ...
    e.globalDefaults = {
      ...
      columnHeader: !0,
      defaultView: "month", /*기본 화면 - monthly*/
      aspectRatio: 1.35,
    ...
    var i = n(3), r = n(4), o = function () {
      ...
      return t.prototype.opt = function (t) {
        ...
        var n = t.footprint, i = e.footprint, o = n.componentFootprint, s = i.componentFootprint, a = o.unzonedRange,
          l = s.unzonedRange
        ;
    ...
    function s(t, e, n, i, r) {
      var o, s, a, l = t.sameUnits, u = e.clone().stripZone(), d = n.clone().stripZone(), c = f(t.fakeFormatString, e),
        p = f(t.fakeFormatString, n), h = "", v = "", y = "", m = "", b = "";
    ...
    /*상호 작용 및 드래그 액션을 처리하기 위한 클래스를 정의*/
    function (t, e, n) {
    Object.defineProperty(e, "__esModule", {value: !0});
    ...
    /*달력의 각 날짜를 표시하는 테이블 헤더와 배경을 렌더링하는 클래스를 정의*/
    function (t, e, n) {
    Object.defineProperty(e, "__esModule", {value: !0});
    ...
    /*이벤트를 끌어다 놓거나 크기를 조정할 때 표시되는 도우미(헬퍼)를 다루는 클래스를 정의*/
    function (t, e, n) {
    Object.defineProperty(e, "__esModule", {value: !0});
    ...
    function (t, e, n) {
    Object.defineProperty(e, "__esModule", {value: !0});
    var i = n(2), r = n(14), o = n(245), s = n(225), a = n(59), l = n(224), u = n(223), d = n(222), c = function (t) {
      function e() {
        return null !== t && t.apply(this, arguments) || this
      }
    ...
    var i = n(2), r = n(3), o = n(4), s = n(53), a = n(249), l = n(5), u = n(12), d = n(36), c = n(56), p = n(60),
      h = n(40), f = n(55), g = n(250), v = n(251), y = n(252), m = function (t) {
        ...
        return i.__extends(e, t), e.prototype.componentFootprintToSegs = function (t) {
          ...
          var n, i, o, s, a, l, u, d, c, p, h, f, g, v, y, m = this, b = this.eventRenderer.rowStructs[t], w = [], D = 0,
            E = function (n) {
    ...
    var r = n(3), o = n(0), s = n(4), a = n(32), l = n(238), u = n(21), d = n(11), c = n(7), p = n(239), h = n(240),
      f = n(241), g = n(207), v = n(31), y = n(10), m = n(5), b = n(12), w = n(17), D = n(242), E = n(212), S = n(38),
      C = n(49), R = n(13), T = n(37), M = n(6), I = n(51), H = function () {
        function t(t, e) {
    ...
    var i = n(3), r = n(4), o = function () {
      ...
      return t.prototype.setToolbarOptions = function (t) {
        ...
        var t = this.toolbarOptions.layout, e = this.el; /*left: 이전 달, 다음 달, today / right: weekly, monthly, daily / center: 월 연도 */
      ...
      }, t.prototype.renderSection = function (section) {
        var self = this,
          calendar = this.calendar,
          theme = calendar.theme,
          optionsManager = calendar.optionsManager,
          viewSpecManager = calendar.viewSpecManager,
          sectionElement = $("<div class='fc-" + section + "'/>"),
          layout = this.toolbarOptions.layout[section],
          customButtons = optionsManager.get("customButtons") || {},
          buttonTextOverrides = optionsManager.overrides.buttonText || {},
          buttonText = optionsManager.get("buttonText") || {};

        if (layout) {
          layout.split(" ").forEach(function (item) {
            var sections = item.split(",");
            var firstButton = true;

            sections.forEach(function (buttonName) {
              var buttonHandler, buttonTextContent, buttonIconClass, viewName, viewButtonText;

              if (buttonName === "title") {
                // Handle title (month and year)
                var titleElement = $("<h2 style='font-family: \"Ubuntu\", sans-serif; font-weight: 700; font-style: normal;'>&nbsp;</h2>");
                sectionElement.append(titleElement);
                firstButton = false;
                return;
              }

              if (buttonName === "prev" || buttonName === "next" || buttonName === "today") {
                // Handle pre-defined button
                buttonHandler = function () {
                  calendar[buttonName]();
                };
                buttonTextContent = buttonTextOverrides[buttonName] || buttonText[buttonName];
              } else {
                var customButton = customButtons[buttonName];
                var viewSpec = viewSpecManager.getViewSpec(buttonName);

                if (customButton) {
                  // Handle custom button
                  buttonHandler = function (event) {
                    customButton.click && customButton.click.call(selectElement[0], event);
                  };
                  buttonIconClass = theme.getCustomButtonIconClass(customButton);
                  buttonTextContent = customButton.text;
                } else if (viewSpec) {
                  // Handle view-specific button
                  self.viewsWithButtons.push(buttonName);
                  buttonHandler = function () {
                    calendar.changeView(buttonName);
                  };
                  buttonTextContent = viewSpec.buttonTextOverride || buttonText[buttonName] || viewSpec.buttonTextDefault;
                }
              }

              if (buttonHandler) {
                var button = $("<button type='button' class='fc-button fc-" + buttonName + "-button'>" + buttonTextContent + "</button>")
                  .click(buttonHandler);

                if (firstButton) {
                  button.addClass(theme.getClass("cornerLeft"));
                  firstButton = false;
                }
            ...
            if (sections.length > 1) {
              sectionElement.append("<span class='fc-separator'></span>");
            }
          });
        }
    ...
    var l = n(2), u = n(4), d = n(42), c = function (t) {
      ...
      return l.__extends(e, t), e.prototype.renderFgSegs = function (t) {
        ...
        return '<a class="' + f.join(" ") + '"' + (d.url ? ' href="' + u.htmlEscape(d.url) + '"' : "") + (g ? ' style="' + g + '"' : "") + '>' +
          '<div class="fc-content" style="color: ghostwhite">' + (n ? '' +
            '<div class="fc-time" data-start="' + u.htmlEscape(r) + '" data-full="' + u.htmlEscape(i) + '">' +
            '<span>' + u.htmlEscape(n) + "</span></div>" : "") + (d.title ?
    ...
    var o = n(2), s = n(3), a = n(4), l = n(42), u = function (t) {
      ...
      return o.__extends(e, t), e.prototype.renderBgRanges = function (e) {
        ...
        t.isStart && (n = this.getTimeText(t.footprint)) && (h = '<span class="fc-time" style="color: ghostwhite;">' + a.htmlEscape(n) + "</span>"),
          i = '<span class="fc-title" style="color: ghostwhite;">' + (a.htmlEscape(o.title.split("/")[0] || "") || "&nbsp;") + "</span>",
        '<a class="' + c.join(" ") + '"' + (o.url ? ' href="' + a.htmlEscape(o.url) + '"' : "") + (p ? ' style="' + p + '"' : "") +
        ' data-calid="'+o.title.split("/")[1]+'"><div class="fc-content">' + (this.dayGrid.isRTL ? i + " " + h : h + " " + i) + "</div>" + (u ?
    ...
    var i = n(2), r = n(4), o = n(42), s = function (t) {
      ...
      return i.__extends(e, t), e.prototype.renderFgSegs = function (t) {
        ...
        return e = l.isAllDay ? n.getAllDayHtml() : n.isMultiDayRange(l.unzonedRange) ? t.isStart || t.isEnd ? r.htmlEscape(this._getTimeText(i.msToMoment(t.startMs), i.msToMoment(t.endMs), l.isAllDay)) : n.getAllDayHtml() : r.htmlEscape(this.getTimeText(s)), u && d.push("fc-has-url"),
        '<tr class="' + d.join(" ") + '">' + (this.displayEventTime ?
          '<td class="fc-list-item-time ' + o.getClass("widgetContent") + '">' + (e || "") + "</td>" : "") +
        '<td class="fc-list-item-marker ' + o.getClass("widgetContent") + '">' +
        '<span class="fc-event-dot"' + (c ? ' style="background-color:' + c + '"' : "") + '></span></td>' +
        '<td class="fc-list-item-title ' + o.getClass("widgetContent") + '">' +
        '<a' + (u ? ' href="' + r.htmlEscape(u) + '"' : "") + ">" + r.htmlEscape(a.title || "") + "</a></td></tr>"
      }, e.prototype.computeEventTimeFormat = function () {
