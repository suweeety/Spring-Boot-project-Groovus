...
public enum ErrorCode {
    ...
    // Project 관련
    PROJECT_INFO_NOT_FORMATTED(HttpStatus.NOT_ACCEPTABLE, ""),
    PROJECT_NOT_FOUND_404(HttpStatus.NOT_FOUND, "해당 PROJECT 존재하지 않습니다"),
    PROJECT_IN_USER_NOT_FOUND_404(HttpStatus.NOT_FOUND, "해당 PROJECT에 존재하는 사용자가 아닙니다"),
    PROJECT_DUPLICATION_409(HttpStatus.CONFLICT, "해당 사용자가 PROJECT에 존재합니다"),
    PROJECT_INVITATION_CODE_NOT_SAME(HttpStatus.FORBIDDEN, "초대 코드가 동일하지 않습니다"),
    PROJECT_INVITATION_CODE_DOES_NOT_EXIST(HttpStatus.FORBIDDEN, "초대 코드를 입력해주세요"),
